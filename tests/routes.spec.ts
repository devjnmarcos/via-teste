...
const routes = [
  ...
  ['app/pages/configuracoes/feature-flags/index.vue', 'MetricsStrip'],
  ['app/pages/configuracoes/feature-flags/index.vue', 'DonutChart'],
  ['app/pages/configuracoes/feature-flags/index.vue', 'StackedBarChart'],
  ['app/pages/configuracoes/feature-flags/[id].vue', 'MetricsStrip'],
  ['app/pages/configuracoes/feature-flags/[id].vue', 'DataTable'],
  ['app/pages/configuracoes/cargos/index.vue', 'MetricsStrip'],
  ['app/pages/configuracoes/cargos/index.vue', 'AppModal'],
